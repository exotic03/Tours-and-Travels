...
$desc=$_POST["desc"];
$add="INSERT INTO package_info SET package_name='$pname',package_price='$price',day='$day',package_image='$img',category='$category',location='$location',package_desc='$desc'";
$connect->query($add);
